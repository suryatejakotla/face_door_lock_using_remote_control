...
# Email configuration
EMAIL = "ssmb248842@gmail.com"  # Replace with your email
PASSWORD = "axsv rqai zkmt phzt"        # Replace with your email password
...
while True:
    ...
    for encoding in encodings:
        ...
        if True in matches:
            ...
            # If an unknown person is detected, capture the image and send it via email
